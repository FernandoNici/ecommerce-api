...
import br.example.ecommerce.checkout.event.CheckoutCreatedEvent;
import br.example.ecommerce.checkout.model.CheckoutEntity;
import br.example.ecommerce.checkout.model.CheckoutItemEntity;
import br.example.ecommerce.checkout.model.ShippingEntity;
import br.example.ecommerce.checkout.repository.CheckoutRepository;
...
import br.example.ecommerce.checkout.util.UUIDUtil;
...
public class CheckoutServiceImpl implements CheckoutService {
    ...
    public Optional<CheckoutEntity> create(CheckoutRequest checkoutRequest) {
        final CheckoutEntity entity = createCheckoutEntityFromRequest(checkoutRequest);
    ...
    private CheckoutEntity createCheckoutEntityFromRequest(CheckoutRequest checkoutRequest) {
